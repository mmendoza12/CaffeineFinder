...
public class CaffeineDetailsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add another LatLng coordinate named myCoordinate based off mMyLocation.
        // Add a custom marker at myCoordinate
        ...
        // Move the camera position to target myCoordinate
