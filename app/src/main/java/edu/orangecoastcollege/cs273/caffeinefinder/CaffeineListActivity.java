...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    //Member variables for the GoogleApiClient, Location and LocationRequest
    // Google API client is "fused" services for all apps on the device (locations, maps, play store)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // If the connection to the GoogleApiClient is null, build a new one:
        ...
        // Make a LocationRequest every 10 seconds, with a fastest interval of 1 second with high accuracy
    ...
    // Override the onStart method to connect to the GoogleApiClient
    @Override
    ...
    // Override the onStop method to disconnect from the GoogleApiClient
    @Override
    ...
    // Updates the user's location (custom marker) on the Google Map
    // Rebuilds all markers for the Caffeine Locations (standard markers)
